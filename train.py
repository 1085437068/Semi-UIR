...
def main(gpu, args):
    ...
    paired_dataset = TrainLabeled(dataroot=train_folder, phase='UIEB/labeled', finesize=args.crop_size)
    unpaired_dataset = TrainUnlabeled(dataroot=train_folder, phase='UIEB/unlabeled', finesize=args.crop_size)
    val_dataset = ValLabeled(dataroot=train_folder, phase='UIEB/val', finesize=args.crop_size)
    paired_sampler = None
...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_pretain', default='True', type=str, help='use pretained model')
    parser.add_argument('--pretrained_path', default='pretrained/model.pth', type=str, help='if pretrained')
